...
public class GenerateVoucher extends AppCompatActivity {
    ...
    public void generateVoucher(View view){
    ...
    public void pinDialog(){
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(GenerateVoucher.this);
        alertDialog.setTitle("PIN");
        alertDialog.setMessage("Enter PIN");

        final EditText input = new EditText(GenerateVoucher.this);
    ...
    public void requestWithSomeHttpHeaders() {
        ...
        String url = Constants.URL + "transactions/generateVoucher/";
