...
public class PurchaseOperation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_purchase_operation);
    ...
    public void purchaseOperation(View view){
    ...
    public void pinDialog(){
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(PurchaseOperation.this);
        alertDialog.setTitle("PIN");
        alertDialog.setMessage("Enter PIN");

        final EditText input = new EditText(PurchaseOperation.this);
    ...
    public void requestWithSomeHttpHeaders() {
        ...
        String url = Constants.URL +  "transactions/purchase/";
